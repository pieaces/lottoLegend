...
const leftLineBtn = document.querySelector('#func1-left-line-chart-btn');
const rightLineBtn = document.querySelector('#func1-right-line-chart-btn');
const lineNum = document.querySelectorAll('.func1-chart-line-num > div');


const lineValueBox1 = document.querySelector('#func1-line-filter-name');
const lineValueBox2 = document.querySelector('#func1-line-times');
const lineTable = document.querySelector('#func1-line-table');

const lineCanvas = document.querySelector('#func1-chart-line');
