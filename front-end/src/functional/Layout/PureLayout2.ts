...
export default class Layout2{
    ...
    private layout2Data: any; //this.layout2Data
    ...
    setWinNumbers(numbers:number[][]){
        this.winNumbers = numbers;
    }
    setLayout2Data(data:any){
    ...
    init() {
        ...
        makeWinNum([[1,2,3,4,5,6],[10,11,12,13,14,15], [21,22,23,24,25,26]], 899);
        bar.create();
