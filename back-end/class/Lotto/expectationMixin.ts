...
const expectationMixIn = <TBase extends Constructor>(Base: TBase) =>
    class extends Base {
        ...
        expectedSum$1(mode: number = this.mode): number[] { // 2~52
            const pos = [
                0.0000012277380399898835, 0.000007980297259934243,
                0.000032535058059731914, 0.00009257144821523722,
                0.00022099284719817903, 0.000463471110096181,
                0.000874149484472797, 0.0015291477288073999,
                0.002506304434835348, 0.0039077674074838,
                0.005809656405232128, 0.008308717185631536,
                0.011432205533169799, 0.015235124112038463,
                0.01963717885442219, 0.024605711928457247,
                0.02996122803269712, 0.035571868101646885,
                0.04113732741072503, 0.04647074423024508,
                0.051223932052065914, 0.05522206097929297,
                0.05815893314475277, 0.05994639695717404,
                0.06041477901943018, 0.059619327543320735,
                0.05752173710199802, 0.05433759849528426,
                0.050191158812826424, 0.04537339197010212,
                0.040084419267629706, 0.03463387623909462,
                0.029215254399599266, 0.02407287361910164,
                0.019332208725288704, 0.015134449592759293,
                0.011529933481152993, 0.008540514127581627,
                0.00613107822410148, 0.0042630747962568724,
                0.0028611207283924245, 0.0018462724645367868,
                0.0011421646986025885, 0.0006719410292864632,
                0.0003759333878449023, 0.0001959469911823854,
                0.00009404473386322507, 0.00003977871249567222,
                0.000015223951695874554, 0.000003928761727967627,
                7.3664282399393e-7
            ];
            return pos.map(value => value * (mode));
        }
        ...
        expectedPrimeCount(mode: number = this.mode): number[] {
            const pos = [
                ...
                0.23736207521980596,
                0.10719577590571881,
                0.029046597342194773,
                0.004372606051513192,
                0.00028210361622665756
            ];
            return pos.map(value => value * mode);
        }
