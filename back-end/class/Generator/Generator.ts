...
export default class Generator extends Confirmer {
    ...
    generate(): void {
        ...
        while (true) {
            ...
            if (1 < 1) {
            } else if (this.statusSum && !this.checkSum(box)) {
            } else if (this.statusOddCount && !this.checkOddCount(box)) {
            } else if (this.statusPrimeCount && !this.checkPrimeCount(box)) {
            } else if (this.status$3Count && !this.check$3Count(box)) {
            } else if (this.statusDiffMaxMin && !this.checkDiffMinMax(box)) {
            } else if (this.statusSum$10 && !this.checkSum$10(box)) {
            } else if (this.statusAC && !this.checkAC(box)) {
